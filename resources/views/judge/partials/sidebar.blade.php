<aside class="sidebar">
    ...
    <ul class="links">
        <li>
            <a href="{{ route('user.rounds.index') }}" class="btn"> DASHBOARD </a>
        </li>
        <li>
            <a href="{{ route('user.friends.index') }}" class="btn"> SUBMISSIONS </a>
        </li>
        <li>
            <a href="{{ route('user.community.index') }}" class="btn"> RESULTS </a>
        </li>
    </ul>
